...
#define HOOK_PIN 1              // this is the default
#define PLAYBACK_BUTTON_PIN 2   // this is the default
...
unsigned int recordTimeStamp;
unsigned int recordingTimeLimit = 60000; // This is the recording time limit in milliseconds 
...
void startRecordingGreeting() {
    ...
    // play beep
    two_tone_Beep();
  frec = SD.open("demo.wav", FILE_WRITE);
